...
#SBATCH --output=/scratch/moprescu/event-privacy/logs/advcpg10_%j.out
#SBATCH --error=/scratch/moprescu/event-privacy/logs/advcpg10_%j.err
...
python ~/event-privacy/scripts/run_advcpg_batch.py \
    ...
    --out /scratch/moprescu/event-privacy/data/advcpg_10_einstein \
    --target /scratch/moprescu/event-privacy/data/albert_einstein.png \
    --prompt "A photo of a person in a classroom, cinematic lighting" \
    --suffix einstein
