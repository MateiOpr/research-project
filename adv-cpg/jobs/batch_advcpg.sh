...
python ~/event-privacy/scripts/run_advcpg_batch.py \
    --input /scratch/moprescu/event-privacy/data/reconstructed_rgb \
    --out /scratch/moprescu/event-privacy/data/reconstructed_protected
